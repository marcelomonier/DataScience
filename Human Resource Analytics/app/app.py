...
if btn_predict:
    ...
    if classe==1:
        st.warning("A predição do modelo para a amostra de teste é de evasão com o valor de probabilidade: {0:.2f}%".format(prob))
    else:
        st.success("A predição do modelo para a amostra de teste é de permanência com o valor de probabilidade: {0:.2f}%".format(prob))
