...
def seleciona_usuarios():
    usuarios_obejtos = Usuario.query.all()
    
    usuarios_json = [usuario.to_json() for usuario in usuarios_obejtos]
    
    return gera_response(200, "usuarios", usuarios_json)


#Selecionar um por vez
...
def cria_usuario():
    ...
    #Utilizar um try catch para gerar o erro
...
#Função geral
def gera_response(status, nome_do_conteudo, conteudo, mensagem=True):
    body = {}
